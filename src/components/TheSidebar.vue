...
<template lang="pug">
button.inline-flex.items-center.p-2.mt-2.ms-3.text-sm.text-gray-500.rounded-lg(:data-drawer-target="id" :data-drawer-toggle="id" :aria-controls="id" type="button" class="sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600")
...
aside.z-40.w-64.transition-transform.-translate-x-full.items-stretch(:id="id" class="sm:translate-x-0" :aria-label="id")
